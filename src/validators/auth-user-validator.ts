...
export const newPasswordValidator = body('password').isString().isLength({min:6, max:20}).trim()
...
export const newPasswordValidation = ()=>[newPasswordValidator, confirmationCodeValidator, inputValidation]